        ...
        return (
          <>
            <div className="grow-1 shrink-1 p-[24px]">
              <div className="mb-[16px] line-clamp-2 w-full overflow-hidden text-ellipsis text-center text-[22px] font-bold text-[#ffffff]">
                {episode.title}
              </div>
              <div className="line-clamp-3 w-full overflow-hidden text-ellipsis text-center text-[14px] font-bold text-[#ffffff]">
                {episode.description}
              </div>
            </div>
